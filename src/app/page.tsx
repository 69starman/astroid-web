  ...
  return (
    <div ref={containerRef} className="relative min-h-screen bg-background overflow-hidden selection:bg-gold/30">
      ...
      <section className="relative z-10 flex flex-col items-center justify-center min-h-[90vh] px-6 pt-32 pb-24 text-center">
        <motion.div 
          className="absolute top-[20%] left-[20%] w-[40%] h-[40%] rounded-full bg-indigo-500/10 blur-[120px] pointer-events-none"
          animate={{ scale: [1, 1.2, 1], opacity: [0.3, 0.5, 0.3] }}
          transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.div 
          className="absolute top-[40%] right-[15%] w-[35%] h-[35%] rounded-full bg-gold/10 blur-[120px] pointer-events-none"
        ...
        <motion.h1 
          ...
          className="max-w-5xl font-display text-5xl md:text-7xl lg:text-8xl font-semibold tracking-tight leading-[1.05]"
        >
        ...
        <motion.p 
          ...
          className="mt-8 max-w-2xl text-lg md:text-xl text-foreground-secondary leading-relaxed"
        >
      ...
      <section className="relative z-10 py-32 px-6 text-center">
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <div className="w-[80%] h-[80%] rounded-full bg-indigo-500/5 blur-[100px]" />
        </motion.div>
        
        <h2 className="font-display text-4xl md:text-6xl font-semibold mb-6">Ready to Build the Future?</h2>
        <p className="text-foreground-secondary text-xl max-w-2xl mx-auto mb-12">
